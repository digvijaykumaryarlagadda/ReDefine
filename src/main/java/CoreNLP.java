...
public class CoreNLP {
    public static void main(String args[]) throws IOException{
        ...
        try {
            File outlemmafile = new File("output/LemmatizationOut.txt");
            outlemma = new BufferedWriter(new FileWriter(outlemmafile));
            File outnerfile = new File("output/NEROut.txt");
            outner = new BufferedWriter(new FileWriter(outnerfile));
            File outposfile = new File("output/POSOut.txt");
            outpos = new BufferedWriter(new FileWriter(outposfile));
        } catch (IOException e) {
            e.printStackTrace();
        }
        FileInputStream fstream = new FileInputStream("output/TXTOut.txt");
